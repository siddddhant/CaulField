...
person = Table('person', post_meta,
    ...
    Column('is_connection_source', Boolean),
...
def upgrade(migrate_engine):
    ...
    post_meta.tables['person'].columns['is_connection_source'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['person'].columns['is_connection_source'].drop()
